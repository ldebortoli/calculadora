...
- **USDT externo**: compara la salida directa por TRON desde cada proveedor y también contempla USDC→Binance Spot→USDT→wallet. El último tramo se agrega pendiente y se excluye del ranking hasta que se seleccione la transición en el mapa, se cargue la comisión fija real de retiro de Binance y la cotización 1:1, y se apliquen los cambios. [Binance indica que el cargo de retiro depende de la red y puede cambiar sin aviso](https://www.binance.com/en-GB/support/faq/crypto-withdrawal-fees-on-binance-d9ff84dccc24423cbe6d59859d86afe3). GrabrFi cobra 1% + USD 1 por USDC frente a 1,1% + USD 1 por USDT; Wallbit Pro cobra 1% frente a 1,25%, pero la conversión Spot y su spread pueden revertir esa diferencia. Llegar a USDT no representa USD billete: faltan cotización, comisión, disponibilidad y condiciones de la contraparte que entregue efectivo.
